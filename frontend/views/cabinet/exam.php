                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <p>
                                                    ...
                                                    $statuses = [
                                                        0 => "Yuklanmagan",
                                                        1 => '<a href="">Tekshirilmoqda <i class="bi bi-arrow-up-right-circle"></i></a>',
                                                        2 => '<a href="">Tasdiqlandi <i class="bi bi-arrow-up-right-circle"></i></a>',
                                                        3 => '<a href="">Bekor qilindi <i class="bi bi-arrow-up-right-circle"></i></a>',
                                                    ];
