...
class EduDirection extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['direction_id', 'lang_id', 'edu_type_id', 'edu_form_id', 'is_oferta', 'status', 'duration','price'], 'required'],
            [['direction_id', 'lang_id', 'edu_type_id', 'edu_form_id', 'is_oferta', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by', 'is_deleted'], 'integer'],
            ...
            [
                ...
                'targetAttribute' => ['direction_id', 'edu_type_id', 'edu_form_id', 'lang_id'], // Unikal kombinatsiya
