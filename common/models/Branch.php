...
class Branch extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name_uz', 'name_ru', 'name_en','address_uz', 'address_ru', 'address_en','tel1',] , 'required'],
            [['location'], 'string'],
            [['tel1', 'tel2'], 'match',
            ...
            [['name_uz', 'name_ru', 'name_en', 'telegram', 'instagram', 'facebook', 'address_uz', 'address_ru', 'address_en', 'tel1', 'tel2'], 'string', 'max' => 255],
        ];
    }
